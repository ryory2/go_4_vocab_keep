...
func (_m *MockReviewService) GetReviewWords(ctx context.Context, tenantID uuid.UUID) ([]*model.ReviewWordResponse, error) {
...
func (_m *MockReviewService) SubmitReviewResult(ctx context.Context, tenantID uuid.UUID, wordID uuid.UUID, isCorrect bool) error {
